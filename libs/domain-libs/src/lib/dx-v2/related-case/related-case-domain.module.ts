...
import { RelatedCaseDomainController } from './related-case-domain.controller';
...
@Module({
  ...
  controllers: [RelatedCaseDomainController],
  providers: [RelatedCaseDomainService],
})
export class RelatedCaseDomainModule {}
