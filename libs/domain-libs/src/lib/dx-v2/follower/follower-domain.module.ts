...
import { FollowerDomainController } from './follower-domain.controller';
...
@Module({
  ...
  controllers: [FollowerDomainController],
  providers: [FollowerDomainService],
})
export class FollowerDomainModule {}
