...
import { CollaborationDomainController } from './collaboration-domain.controller';
...
@Module({
  ...
  controllers: [CollaborationDomainController],
  providers: [CollaborationDomainService],
})
