...
@Component({
  selector: 'app-unitdays',
  templateUrl: './unitdays.component.html',
  styleUrls: ['./unitdays.component.scss']
})
export class UnitdaysComponent implements OnInit {
  ...
  fieldClick(e: MouseEvent) {
    // 
  }
  fieldBlur(e: FocusEvent) {
    //
  }
}
